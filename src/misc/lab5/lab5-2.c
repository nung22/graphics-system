/*
  ...
  Test function for 3D matrix viewing - Rectangular Prism
 */
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
int main(int argc, char *argv[]) {
  ...
  // set some colors
  color_set( &color[0], 0, 0, .5 );
  color_set( &color[1], 0, .5, 0 );
  color_set( &color[2], .5, 0, 0 );
  color_set( &color[3], .8, 0, .8 );
  color_set( &color[4], 0, .8, .8 );
  color_set( &color[5], .8, .8, 0 );
  ...
  point_set( &v[0], -2, -1, -1, 1 );
  point_set( &v[1],  2, -1, -1, 1 );
  point_set( &v[2],  2,  1, -1, 1 );
  point_set( &v[3], -2,  1, -1, 1 );
  point_set( &v[4], -2, -1,  1, 1 );
  point_set( &v[5],  2, -1,  1, 1 );
  point_set( &v[6],  2,  1,  1, 1 );
  point_set( &v[7], -2,  1,  1, 1 );
  ...
  image_write( src, "rectangular-prism.ppm" );
